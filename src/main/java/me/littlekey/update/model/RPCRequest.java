...
public final class RPCRequest extends Message<RPCRequest, RPCRequest.Builder> {
  ...
  public RPCRequest(ByteString session_id, ByteString content) {
    this(session_id, content, ByteString.EMPTY);
  }

  public RPCRequest(ByteString session_id, ByteString content, ByteString unknownFields) {
